...
import { loginUser } from "../app/providers/authSlice";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        ...
        title: "Erreur",
        text:
          "Vous avez mal renseigné les champs ou cet élément existe déjà dans la base de données",
      });
      console.log(error);
    }
  };
        ...
        <div className="row  justify-content-center">
                   ...
                   <div className="col-md-6 pt-4">
                     ...
                     <div className="row align-items-center justify-content-center">
                         ...
                         <div className="col-6"><img src="/assets/img/medecin1.png" alt="hello-doc" className="rounded-icon img-fluid"/></div>
