...
export default function ProfilEdit(){
    ...
    const handleSubmit = async (event) => {
        ...
        await Profilsservices.update(location.state.id, form,token).then((response) => {
    ...
    const edit = async () => {
        try {
            const response = await Profilsservices.edit(location.state.id, token);
            ...
            if (response.data) {
               ...
               // console.log("data", data);
                ...
                setSelectedOptionHabilitations(data.selectedOptionHabilitations)
